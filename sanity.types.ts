...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | LessonCompletion | Enrollment | BlockContent | Lesson | Module | Course | Student | Instructor | Category | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Slug;
...
// Source: sanity/lib/courses/getRelatedCourses.ts
// Variable: getRelatedCoursesQuery
// Query: *[_type == "course" && _id != $courseId && category._ref == $categoryId][0...$limit] {    ...,    "slug": slug.current,    "category": category->{...},    "instructor": instructor->{...}  }
export type GetRelatedCoursesQueryResult = Array<{
  _id: string;
  _type: "course";
  _createdAt: string;
  _updatedAt: string;
...
// Source: sanity/lib/lessons/getCompletedLessons.ts
// Variable: completedLessonsQuery
// Query: {    "completedLessons": *[_type == "lessonCompletion" && student._ref == $studentId && course._ref == $courseId] {      ...,      "lesson": lesson->{...},      "module": module->{...},      _createdAt    }  }
export type CompletedLessonsQueryResult = {
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"course\" && _id != $courseId && category._ref == $categoryId][0...$limit] {\n    ...,\n    \"slug\": slug.current,\n    \"category\": category->{...},\n    \"instructor\": instructor->{...}\n  }": GetRelatedCoursesQueryResult;
    "*[_type == \"course\" && (\n    title match $term + \"*\" ||\n    description match $term + \"*\" ||\n    category->name match $term + \"*\"\n  )] {\n    ...,\n    \"slug\": slug.current,\n    \"category\": category->{...},\n    \"instructor\": instructor->{...}\n  }": SearchQueryResult;
    "{\n    \"completedLessons\": *[_type == \"lessonCompletion\" && student._ref == $studentId && course._ref == $courseId] {\n      ...,\n      \"lesson\": lesson->{...},\n      \"module\": module->{...},\n      _createdAt\n    }\n  }": CompletedLessonsQueryResult;
